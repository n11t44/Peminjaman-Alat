...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
        <div class="p-5 border-b border-gray-200 bg-gray-50 flex flex-col md:flex-row md:justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                ...
                <form action="{{ route('admin.kategori.index') }}" method="GET" class="flex w-full md:w-80">
                    ...
                    <button type="submit"
                        class="bg-gray-800 hover:bg-gray-900 text-white px-4 py-2 text-sm rounded-lg ml-2 transition">
                        Cari
                    </button>
                </form>
