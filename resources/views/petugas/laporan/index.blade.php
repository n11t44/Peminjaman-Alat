        ...
        <form action="{{ route('petugas.laporan.index') }}"
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('petugas.laporan.index') }}"
                   class="bg-gray-400 hover:bg-gray-500 text-white px-3 py-2 text-sm rounded-lg transition flex items-center justify-center">
                    Reset
                </a>
            ...
            <tbody class="text-gray-700 text-sm">
                ...
                @forelse($laporans as $index => $item)
                    ...
                    <tr class="hover:bg-gray-50 transition align-top">
                        ...
                        {{-- Peminjam --}}
                        <td class="px-3 py-4 border-b font-medium text-gray-900">
                            {{ $item->user->name ?? '-' }}
                        </td>
